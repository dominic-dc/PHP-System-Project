            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <?php
                            $sql = "SELECT * FROM posts WHERE post_status = ? ORDER BY post_views DESC LIMIT 1";
                        ...
                        ?>
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM posts WHERE post_status = :status ORDER BY post_id DESC LIMIT 6";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':status' => "Published"
                                    ]);
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM posts WHERE post_status = :status ORDER BY post_views DESC LIMIT 3";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':status' => 'Published'
                                    ]);
                                ...
                                <?php
                                    ...
                                    while($categories = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <div class="col-lg-4 col-md-6 mb-5">
                                            <a class="card card-link border-top border-top-lg border-primary h-100 lift" href="categories.php?category_id=<?php echo $category_id; ?>&category_name=<?php echo $category_name; ?>"
