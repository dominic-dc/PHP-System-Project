            ...
            <div id="layoutDefault_content">
                <main>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        ...
                                        <h1 class="page-header-title"><?php echo $_GET['category_name']; ?></h1>
                                            ...
                                            <div class="form-row justify-content-center">
                                                <div class="col-lg-6 col-md-8">
                                                    <div class="form-group mr-0 mr-lg-2">
                                                        ...
                                                        <input type="hidden" name="category-id" value=<?php echo $_GET['category_id']; ?>>
                                                    </div>
                                                </div>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                            <?php
                                $sql = "SELECT * FROM posts WHERE post_status = ? AND post_category_id = ? ORDER BY post_views DESC LIMIT 1";
                                $stmt = $pdo->prepare($sql);
                                $stmt->execute(['Published', $_GET['category_id']]);
                            ...
                            <div class="row">
                               <?php
                                    ...
                                    $sql = "SELECT * FROM posts WHERE post_status = :status AND post_category_id = :id ORDER BY post_id DESC LIMIT 6";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':status' => 'Published',
                                        ':id' => $_GET['category_id']
                            ...
                            <div class="row">
                                <?php
                                    ...
                                    $sql = "SELECT * FROM posts WHERE post_status = :status AND post_category_id = :id ORDER BY post_views DESC LIMIT 3";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':status' => 'Published',
                                        ':id' => $_GET['category_id']
