                ...
                <main>
                    ...
                    <?php
                        if(isset($_POST['search-keyword'])) {
                            ...
                            $sql = "SELECT * FROM posts WHERE post_status = ? AND post_title LIKE ?";
                            $stmt = $pdo->prepare($sql);
                            $stmt->execute(['Published', '%'. trim($keyword) .'%']);
                            $post_found = 0;
                            $count = $stmt->rowCount();
                            if($count == 0) {
                                $post_found = 0;
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    $sql = "SELECT * FROM posts WHERE post_status = :status AND post_title LIKE :title ORDER BY post_id DESC LIMIT 6";
                                    $stmt = $pdo->prepare($sql);
                                    $stmt->execute([
                                        ':status' => 'Published',
                                        ':title' => '%'. trim($keyword) .'%'
